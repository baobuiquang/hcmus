...
////////////////////////////////////////////////////////////
	...
	pcb[ID]->SetFileName(filename); // Dat ten cho tien trinh

	pcb[ID]->parentID=currentThread->processID; //parentID la processID cua currentThread
	bm->Mark(ID);
...
/////////////////////////////////////////////////////////////
	...
	pcb[pcb[pID]->parentID]->DecNumWait(); // giam so tien trinh cho cua tien trinh cha
